...
<p align="center">
  <a href="https://www.npmjs.com/package/create-profile-api"><img alt="npm" src="https://img.shields.io/npm/v/create-profile-api?label=npm%20create%20profile-api&color=d5a93f"></a>
...
<p align="center">
  Your CV as a browsable API: <code>GET /experience</code>, <code>GET /skills?filter=backend</code>, <code>POST /hire</code>.<br>
...
```bash
npm create profile-api my-site        # pick a design: -- --theme git
cd my-site
pnpm install
...
packages/           create-profile-api — the `npm create` scaffolder (no dependencies)
